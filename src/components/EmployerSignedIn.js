  ...
  return (
    <>
        ...
        <Menu.Item>
            ...
            />
            <Dropdown pointing="top right" text={authItem[0].employer.companyName}>
                <Dropdown.Menu>

                    {authItem[0].employer.employerType === 1 &&( 
                    <Dropdown.Item as={Link} to="/isveren/profile">
                        Profile
                    </Dropdown.Item>)}
                    <Dropdown.Item>
                        Özgeçmiş Güncelle
                    </Dropdown.Item>
                    <Dropdown.Item onClick={() => handleLogout(authItem[0].employer)}>
                        Çıkış Yap
                    </Dropdown.Item>
                </Dropdown.Menu>
            </Dropdown>
